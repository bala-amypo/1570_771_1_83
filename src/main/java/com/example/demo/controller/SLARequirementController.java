...
@Tag(name = "SLA Requirements", description = "SLA requirement management endpoints")
...
public class SLARequirementController {
    ...
    @PostMapping
    @Operation(summary = "Create a new SLA requirement")
    ...
    public ResponseEntity<SLARequirement> updateRequirement(@PathVariable Long id, 
                                                            @RequestBody SLARequirement requirement) {
